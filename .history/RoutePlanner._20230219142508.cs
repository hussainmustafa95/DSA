                                          ...
                                          bool[,] mapMatrix)
        {
            ...
            while(s.Any()){
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    if(!IsSafe(new_row, new_col, visited)) return false;
                     if(!mapMatrix[new_row,new_col]) continue;
                    if(new_row == toRow && new_col == fromColumn) return true;
